...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['purohit-owner', 'ritual-coordinator', 'purohit-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Booking', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Purohit', path: '/purohits', entity: 'purohit', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
