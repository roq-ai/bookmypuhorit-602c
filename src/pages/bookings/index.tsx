            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('purohit', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>purohit</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('purohit', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/purohits/view/${record.purohit?.id}`}>
                          {record.purohit?.availability}
                        </Link>
                      </Td>
                    )}
