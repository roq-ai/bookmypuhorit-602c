...
import { getPurohitById } from 'apiSdk/purohits';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('purohit', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/purohits/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/bookings/create?purohit_id=${data?.id}`}>
